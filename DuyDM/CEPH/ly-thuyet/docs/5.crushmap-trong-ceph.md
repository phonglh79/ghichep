...
```
Description: Kết quả hiện tại đổ vào đầu ra stack, thường đường sử dụng ở phần cuối của rule, nhưng cũng có thể được sử dụng từ một case khách trong cùng rule.
Purpose:	Một thành phần của rule.
